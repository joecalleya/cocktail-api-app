...
import styles from './DrinkCard.module.scss'
 ...
 const DrinkCard = (props) => {
   ...
   const {idDrink, strDrink, strDrinkAlternate, strDrinkES, strDrinkDE, strDrinkFR, 
        strDrinkThumb,  strTags, strVideo, strCategory, strIBA, strAlcoholic, strGlass, strInstructions, 
